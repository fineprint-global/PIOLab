...
Check_Balance <- function()
{
  ...
  write.xlsx( df, file = paste0( path$output,"/SI/",job$year,"_Data for process balances.xlsx") )
  ...
  ggsave(path = paste0(path$output), 
         filename = paste0(job$year,"_MatBal_Scatter_Pro.png"),
         width = 6, height = 6.5 )
  ...
  # Save plot: 
  ggsave(path = paste0(path$output), 
         filename = paste0(job$year,"_MatBal_Scatter_Reg.png"),
         width = 10, height = 7 )
  ...
  # Save plot: 
  ggsave(path = paste0(path$output), 
         filename = paste0(job$year,"_TotalOutput_Histogram.png"),
         width = 10, height = 7 )
