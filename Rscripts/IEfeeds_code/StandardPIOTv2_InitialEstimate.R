...
{
  file <- paste0("S8 ",path$IE_Processed,"/S8files/",gsub("-","",Sys.Date()),
...
# Write command for supply tables
ALANG <- NewALANG("Supply","E MX1;MN10;",ALANG)
ALANG <- NewALANG("Use","E MX10;MN100;CN1000;",ALANG)
ALANG <- NewALANG("FinalDemand","E MX10;MN100;",ALANG)
ALANG <- NewALANG("Extraction","E MX0.05;MN1;",ALANG)
ALANG <- NewALANG("EolScrap","E MX0.20;MN10;",ALANG)
ALANG <- NewALANG("OtherInput","E MX10;MN100;",ALANG)
ALANG <- NewALANG("Waste","E MX10;MN100;",ALANG)
ALANG <- NewALANG("Zero","E CN1000;",ALANG)
