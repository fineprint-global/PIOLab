...
ALANG <- NewALANG("Supply","E MX0.2;MN1;",ALANG)
ALANG <- NewALANG("Use","E MX1;MN10;CN1;",ALANG)
ALANG <- NewALANG("FinalDemand","E MX1;MN10;",ALANG)
ALANG <- NewALANG("Extraction","E MX0.05;MN0.30;",ALANG)
ALANG <- NewALANG("EolScrap","E MX0.05;MN0.50;",ALANG)
ALANG <- NewALANG("OtherInput","E MX0.2;MN1;",ALANG)
ALANG <- NewALANG("Waste","E MX0.2;MN1;",ALANG)
