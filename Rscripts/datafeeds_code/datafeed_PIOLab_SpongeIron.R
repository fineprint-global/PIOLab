...
# Select Sponge Iron production
item_page <- items[[1]]$page
...
data <- SE_LogRegression(data,0.5,0.1)
...
{ 
  ...
  ALANG <- add_row(ALANG,'1' = paste0("DataFeed WSA Sponge Iron ",reg_name),
                   Value = value,'Row parent' = reg_num,'Row child' = "1",'Row grandchild' = "7",
                   'Column parent' = reg_num,'Column child' = "2",'Column grandchild' = "7-10",S.E. = SE)
}
# Add other variables
