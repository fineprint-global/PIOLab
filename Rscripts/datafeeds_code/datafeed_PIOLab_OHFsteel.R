...
# Select OHF steel production
item_page <- items[[6]]$page
...
{ 
  ...
  ALANG <- add_row(ALANG,'1' = paste0("DataFeed WSA Liquid steel from OHF ",reg_name),
                   Value = value,'Row parent' = reg_num,'Row child' = "1",'Row grandchild' = "21",
                   'Column parent' = reg_num,'Column child' = "2",'Column grandchild' = "32",S.E. = SE)
}
# Add other variables
