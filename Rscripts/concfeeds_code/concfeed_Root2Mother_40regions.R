...
print("Start of 40 region R2M concfeed.")
...
# Load M2M aggregator (49 to 40 regions)
M2M <- read.xlsx( paste0(path$Concordance,'/Region Aggregators/RegionAggregator_49_to_40.xlsx') )
...
Numbers2File( R2M_40, paste0(path$Concordance,'/Region Aggregators/040_RegionAggregator.csv') )
