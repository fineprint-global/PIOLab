...
# a 32 region mother classification. It builds on the 49 region R2M aggregator
# and a given mother-2-mother aggregator.

# Author: hanspeter.wieland@wu.ac.at
# Date : 07.22.2020

print("Start of 32 region R2M concfeed.")
...
M2M <- read.xlsx( paste0(path$Concordance,'/Region Aggregators/RegionAggregator_49_to_32.xlsx') )
M2M <- as.matrix( M2M[,5:ncol(M2M)] )


R2M_32 <- R2M_49 %*% M2M   # Create new R2M aggregator


# Check the sums of the aggregators and print out
print( paste( 'Check sum of R2M aggregator (221 -> 49):',sum(R2M_49) ) )
print( paste( 'Check sum of M2M aggregator (49 -> 32):',sum(M2M) ) )
print( paste( 'Check sum of new R2M aggregator (221 -> 32):',sum(R2M_32) ) )

# Write new aggregator into concordance library folder
Numbers2File( R2M_32, paste0(path$Concordance,'/Region Aggregators/032_RegionAggregator.csv') )
