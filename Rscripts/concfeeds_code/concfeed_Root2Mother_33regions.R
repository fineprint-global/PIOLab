...
print("Start of 33 region R2M concfeed.")
...
M2M <- read.xlsx( paste0(path$Concordance,'/Region Aggregators/RegionAggregator_49_to_33.xlsx') )
M2M <- as.matrix( M2M[,5:37] )
...
print( paste( 'Check sum of M2M aggregator (49 -> 33):',sum(M2M) ) )
print( paste( 'Check sum of new R2M aggregator (221 -> 33):',sum(R2M_40) ) )

# Write new aggregator into concordance library folder
Numbers2File( R2M_40, paste0(path$Concordance,'/Region Aggregators/033_RegionAggregator.csv') )
